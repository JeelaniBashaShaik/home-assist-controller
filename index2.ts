...
// inputs to pi
const ldrInput = new GPIO(14, 'in', 'rising', {debounceTimeout: 10});
const fireInput = new GPIO(15, 'in', 'rising', {debounceTimeout: 10});
const mq6Input = new GPIO(18, 'in', 'rising', {debounceTimeout: 10});
const motionSensorInput = new GPIO(23, 'in', 'rising', {debounceTimeout: 10});

const waterTwentyFive = new GPIO(1, 'in', 'rising', {debounceTimeout: 10});
const waterFifty = new GPIO(7, 'in', 'rising', {debounceTimeout: 10});
const waterSeventyFive = new GPIO(8, 'in', 'rising', {debounceTimeout: 10});
const waterHundred = new GPIO(25, 'in', 'rising', {debounceTimeout: 10});
